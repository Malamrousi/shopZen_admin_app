...
class AppTextStyles {
  ...
  static TextStyle font12RegularFixedFontSize(BuildContext context) =>
      TextStyle(
        fontSize: 12.sp,
        fontWeight: FontWeightManger.regular,
        color: context.colorThemeExtension.mainColor,
  ...
  static TextStyle font14RegularThemeColorFixedFontSize(BuildContext context) =>
      TextStyle(
        fontSize: 14.sp,
        fontWeight: FontWeightManger.regular,
        color: context.colorThemeExtension.mainColor,
  ...
  static TextStyle font19RegularThemeColorFixedFontSize(BuildContext context) =>
      TextStyle(
        fontSize: 19.sp,
  ...
  static TextStyle font16MediumFixedFontSize(BuildContext context) => TextStyle(
    ...
    static TextStyle fontMediumFixedFontSizeWhite(BuildContext context) => TextStyle(
        fontSize: 8.sp,
        fontWeight: FontWeightManger.medium,
  ...
  static TextStyle font16MediumPrimary700FixedFontSize(BuildContext context) =>
      TextStyle(
        fontSize: 16.sp,
        fontWeight: FontWeightManger.medium,
        color: ColorsManger.primaryColor700,
  ...
  static TextStyle font18BoldPrimary700FixedFontSize(BuildContext context) =>
      TextStyle(
        fontSize: 18.sp,
        fontWeight: FontWeightManger.bold,
        color: ColorsManger.primaryColor700,
  ...
  static TextStyle font15WhiteColorRegularFixedFontSize(BuildContext context) =>
      TextStyle(
        fontSize: 15.sp,
        fontWeight: FontWeightManger.regular,
        color: ColorsManger.whiteColor,
